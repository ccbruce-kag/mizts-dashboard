...
const SCROLL_FIELDS = {
  ...
  [RightSidebarScrollField.PrivacyType]: i18n.translate(
    ...
    {
      defaultMessage: '私人工作空間(Workspace privacy)',
    }
  ),
};
          ...
          {isExpanded ? (
            <EuiBadge>
              {i18n.translate('workspace.form.summary.items.showLess', {
                defaultMessage: '顯示較少(Show less)',
              })}
            </EuiBadge>
          ) : (
            <EuiBadge>
              {i18n.translate('workspace.form.summary.items.showAll', {
                defaultMessage: '+{itemsOfNumber} 更多',
...
export const WorkspaceFormSummaryPanel = ({
  ...
  return (
    <EuiCard
      title={i18n.translate('workspace.form.summary.panel.title', { defaultMessage: '摘要' })}
      textAlign="left"
      titleSize="s"
    >
      <EuiSpacer size="s" />
