  ...
  return (
    ...
    >
      ...
      <EuiCollapsibleNavGroup
        key="recentlyViewed"
        background="light"
        title={i18n.translate('core.ui.recentlyViewed', { defaultMessage: '最近瀏覽過' })}
        isCollapsible={true}
          ...
          <EuiText size="s" color="subdued" style={{ padding: '0 8px 8px' }}>
            <p>
              {i18n.translate('core.ui.EmptyRecentlyViewed', {
                defaultMessage: '最近沒項目-No recently viewed items',
              })}
            </p>
          </EuiText>
        )}
            ...
            >
              <EuiListGroup
                aria-label={i18n.translate('core.ui.primaryNavSection.screenReaderLabel', {
                  defaultMessage: '主要導航鏈接， {category}',
