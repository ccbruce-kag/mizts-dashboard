...
yarn build-platform --skip-os-packages --skip-archives --with-translations
...
```bash
$ cd plugins
$ git clone --branch 2.19.1.0 https://github.com/opensearch-project/security-dashboards-plugin.git

git clone --branch v4.12.0 https://github.com/wazuh/wazuh-security-dashboards-plugin.git
$ cd ..
git clone --branch v4.12.0 https://github.com/wazuh/wazuh-dashboard-plugins.git
$ yarn osd bootstrap --single-version=loose
```
